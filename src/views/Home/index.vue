          ...
          <div class="w-10/12 px-4">
            ...
            >
              ...
              >
                <!-- Movie Image -->
                <div class="w-1/2">
                  <img :src="movie.Poster" alt="movie.title" class="w-full h-68 md:h-98 object-cover rounded-l-lg" />
                </div>
                <!-- Movie Info -->
                <div class="w-1/2 p-6 flex flex-col justify-center bg-[#121212] h-58 md:h-94">
